...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ 
    ...
    const variants = {
      ...
      secondary: 'bg-gray-800 text-white hover:bg-gray-900 focus:ring-gray-500 disabled:bg-gray-300',
      ...
      ghost: 'text-emerald-600 hover:bg-emerald-50 focus:ring-emerald-500 disabled:text-gray-300'
    };
