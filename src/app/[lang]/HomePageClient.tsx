          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="space-y-8">
              <h3 className="text-4xl font-black mb-6">
                {validLang === 'it' ? 'Inizia il Tuo Viaggio Finanziario' : 'Start Your Financial Journey'}
              </h3>
              <p className="text-xl text-gray-600 leading-relaxed mb-8">
                {validLang === 'it' 
                  ? 'Prendi il controllo delle tue finanze con strategie pratiche e consigli esperti.'
                  : 'Take control of your finances with practical strategies and expert advice.'}
              </p>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <p className="font-bold text-lg mb-2">
                      {validLang === 'it' ? 'Budget Facilitato' : 'Budgeting Made Easy'}
                    </p>
                    <p className="text-gray-600 leading-relaxed">{t.navigating.budgeting}</p>
                  </div>
                </div>
                <div className="flex gap-4 items-start">
                  <div className="flex-shrink-0 mt-1">
                  ...
                  <div>
                    <p className="font-bold text-lg mb-2">
                      {validLang === 'it' ? 'Pianificazione Pensionistica' : 'Retirement Planning'}
                    </p>
                    <p className="text-gray-600 leading-relaxed">{t.navigating.retirement}</p>
                  </div>
                </div>
              </div>
      ...
      <section className="relative bg-gray-100 py-40 lg:py-52 text-black">
        <div className="w-full max-w-[1600px] mx-auto px-6 sm:px-10 md:px-16 lg:px-24 xl:px-32">
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="relative h-[500px] lg:h-[600px] rounded-3xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute inset-0 flex items-center justify-center p-8">
                <div className="bg-white rounded-2xl p-10 max-w-md shadow-2xl">
                  ...
                  <h3 className="text-3xl font-black mb-4">{t.mastering.cardTitle}</h3>
                  <p className="text-gray-600 leading-relaxed mb-6">{t.mastering.cardText}</p>
                  <a
                    href={`/${validLang}/blog`}
            ...
            <div className="space-y-8">
              <h3 className="text-4xl font-black">{t.mastering.rightTitle}</h3>
              <p className="text-xl text-gray-600 leading-relaxed">{t.mastering.rightText}</p>
              <a
                href={`/${validLang}/blog`}
      ...
      <section className="bg-gray-100 py-40 lg:py-52 text-black">
        <div className="w-full max-w-[1400px] mx-auto px-6 sm:px-10 md:px-16 lg:px-24 xl:px-32">
          ...
          <div className="grid gap-10 md:grid-cols-3">
            {t.posts.slice(0, 6).map((article, index) => (
          ...
          <div className="text-center mt-16">
            ...
            >
              {validLang === 'it' ? 'Esplora il Blog' : 'Explore Blog'}
            </a>
          </div>
        </div>
      </section>
